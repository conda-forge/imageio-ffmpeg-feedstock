...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6160&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/imageio-ffmpeg-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `imageio-ffmpeg` can be installed with:

```
conda install imageio-ffmpeg
```

It is possible to list all of the versions of `imageio-ffmpeg` available on your platform with:
